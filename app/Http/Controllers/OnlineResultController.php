...
use App\Models\OnlineResult;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;
use Illuminate\Support\Facades\File;
use Illuminate\Support\Facades\URL;

class OnlineResultController extends Controller
{
    /**
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(OnlineResult $onlineResult)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(OnlineResult $onlineResult)
    {
    ...
    public function update(Request $request, $id)
    {
        ...
        $onlineResult = OnlineResult::find($id);
    ...
    {
        $result = OnlineResult::findOrFail($id);
