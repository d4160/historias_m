    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" id="examEditModalHeader">
                <h4 class="modal-title">Editar Examen Auxiliar (<span id="edit_titulo">{{ old('edit_titulo', 'Title') }}</span>)</h4>
            ...
            <div class="modal-body">
                <form id="exam_edit_form" method="POST" class="mt-0" action="{{ route('examen_auxiliares.update', old('exam_edit_id', 1)) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group" id="replace_file">
                        <a target="_blank" id="edit_file_download">Archivo actual: <span id="edit_file_url"></span></a><br>
                        <label for="edit_file1" style="letter-spacing: 0px;" class="mt-2">Reemplazar por: </label>
                    ...
                    <div class="form-group" id="put_file">
