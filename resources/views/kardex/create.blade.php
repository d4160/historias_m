<!-- Modal -->
<div class="modal fade form-modal" id="examModal" tabindex="-1" role="dialog" aria-labelledby="examenClinicoModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="formExamenClinico" class="mt-0" action="{{ route('citas.update_examen_clinico') }}" enctype="multipart/form-data">
                    @csrf
